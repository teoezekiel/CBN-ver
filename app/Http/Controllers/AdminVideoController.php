<?php namespace App\Http\Controllers;
	...
	class AdminVideoController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Video Cover","name"=>"video_cover","image"=>true];
			...
			$this->form[] = ['label'=>'Video Cover','name'=>'video_cover','type'=>'upload','validation'=>'required|image','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Video Name','name'=>'video_name','type'=>'upload','validation'=>'required|mimes:mp4,ogx,oga,ogv,ogg,webm','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'radio','width'=>'col-sm-10','dataenum'=>'0|hidden; 1|show;'];
			...
			//$this->form[] = ['label'=>'Category','name'=>'category','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Video Cover','name'=>'video_cover','type'=>'upload','validation'=>'required|image','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Video Name','name'=>'video_name','type'=>'upload','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Status','name'=>'status','type'=>'radio','width'=>'col-sm-10','dataenum'=>'1|show; 0|hidden'];
			# OLD END FORM
		...
		";
	        ...
	        */
	        ...
	        |
	        */
	        $this->load_js = array("assets/js/bootstrap5-bundle.min.js",
	    ...
	    */
		...
		public function getAdd() {
			$data['creator_teams'] = DB::table('category')->select('id', 'title', 'title as val')->get();
			return $this->view('admin/video_adding', $data);
		}
